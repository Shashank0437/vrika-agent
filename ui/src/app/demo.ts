...
export const DEMO_TOOLS: Tool[] = [
  ...
  { name: 'x8',           desc: 'Hidden HTTP parameter discovery via response diffing',     category: 'web_recon', endpoint: '/api/tools/x8',           method: 'POST', params: { url: r() },    optional: { wordlist: '', method: 'GET', body: '', headers: '', additional_args: '' },                                    effectiveness: 0.83 },
  ...
  { name: 'zaproxy',             desc: 'OWASP ZAP web application security scanner',                             category: 'web_vuln', endpoint: '/api/tools/zaproxy-alternative',                 method: 'POST', params: { target: r() },        optional: { scan_type: 'baseline', api_key: '', port: '8090', output_format: 'xml', additional_args: '' }, effectiveness: 0.88 },
